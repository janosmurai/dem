...
@patch("dem.cli.command.create_cmd.DevEnvSettingsApp")
...
def test_open_dev_env_settings_panel(mock_convert_to_printable_tool_images : MagicMock,
                                     mock_DevEnvSettingsApp: MagicMock) -> None:
    # Test setup
    ...
    mock_dev_env_settings_app = MagicMock()
    mock_selected_tool_images = MagicMock()
    mock_dev_env_settings_app.tool_image_menu.get_selected_tool_images.return_value = mock_selected_tool_images
    mock_DevEnvSettingsApp.return_value = mock_dev_env_settings_app

    mock_dev_env_settings_app.cancel_save_menu.get_selection.return_value = "save"
    ...
    mock_DevEnvSettingsApp.assert_called_once_with(mock_printable_tool_images)
    mock_dev_env_settings_app.wait_for_user.assert_called_once()
    mock_dev_env_settings_app.cancel_save_menu.get_selection.assert_called_once()
    mock_dev_env_settings_app.tool_image_menu.get_selected_tool_images.assert_called_once()
...
def test_open_dev_env_settings_panel_cancel(mock_convert_to_printable_tool_images: MagicMock,
    ...
    mock_dev_env_settings_app = MagicMock()
    mock_selected_tool_images = MagicMock()
    mock_dev_env_settings_app.selected_tool_images = mock_selected_tool_images
    mock_DevEnvSettingsApp.return_value = mock_dev_env_settings_app

    mock_dev_env_settings_app.cancel_save_menu.get_selection.return_value = "cancel"
